...
void AssignmentTesting () {
	...
	cout << endl;
	cout << "Case 1: the size of the rhs matrix is the same with the lhs matrix" << endl;
	{
		double columnLhs[4]={1,2,3,4};
		double rowLhs[3]={1,2,3};
		double columnRhs[4]={5,6,7,8};
		double rowRhs[3]={5,6,7};
		Matrix lhs = Matrix::Toeplitz(columnLhs, 4, rowLhs, 3);
		cout << "the lhs matrix = " << endl;
		cout << lhs << endl;
		Matrix rhs = Matrix::Toeplitz(columnRhs, 4, rowRhs, 3);
		cout << "the rhs matrix = " << endl;
		cout << rhs << endl;
		cout << "the lhs matrix after assignment = " << endl;       
		lhs = rhs;
		cout << lhs << endl;
		cout << "Press any key to continue ..." << flush;
		system("read");
	...
	cout << "Case 2: the size of rhs matrix is larger than lhs matrix" << endl;
	{
		
		double columnLhs[3]={1,2,3};
		double rowLhs[2]={1,2};
		double columnRhs[4]={5,6,7,8};
		double rowRhs[3]={5,6,7};
		Matrix lhs = Matrix::Toeplitz(columnLhs, 3, rowLhs, 2);
		cout << "the lhs matrix = " << endl;
		cout << lhs << endl;
		Matrix rhs = Matrix::Toeplitz(columnRhs, 4, rowRhs, 3);
		cout << "the rhs matrix = " << endl;
	...
	cout << "Case 3: the size of rhs matrix is smaller than lhs matrix " << endl;
	{
	
		double columnLhs[4]={1,2,3,4};
		double rowLhs[3]={1,2,3};
		double columnRhs[3]={5,6,7};
		double rowRhs[2]={5,6};
		Matrix lhs = Matrix::Toeplitz(columnLhs, 4, rowLhs, 3);
		cout << "the lhs matrix = " << endl;
		cout << lhs << endl;
		Matrix rhs = Matrix::Toeplitz(columnRhs, 3, rowRhs, 2);
		cout << "the rhs matrix = " << endl;
		cout << rhs << endl;
		cout << "the lhs matrix after assignment = " << endl;       
		lhs = rhs;
